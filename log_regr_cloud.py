...
##Sources
In my research of logistic regression in MLlib, I came across (https://samarthbhargav.wordpress.com/2014/04/22/logistic-regression-in-apache-spark/)
and [this Spark documentation](https://spark.apache.org/docs/1.3.0/mllib-linear-methods.html).  I borrowed their code and repurposed based on the data.

##Training and Test Data
I used the 2007 sets as the training sets and the 2008 sets as the test sets.
...
train_join_data.persist()
train_join_data.take(5)
